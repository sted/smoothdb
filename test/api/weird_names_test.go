...
func TestWeirdNames(t *testing.T) {
	...
	tests := []test.Test{
		...
		},
		{
			...
			Body:        ``,
			Expected:    `{"name":"table1","schema":"public","owner":"admin","comment":null,"rowsecurity":false,"hasindexes":false,"hastriggers":false,"ispartition":false,"constraints":null,"columns":[{"name":"a.a","type":"int4","notnull":false,"default":null,"readonly":false,"comment":null,"constraints":null,"table":"table1","schema":"public"}]}`,
			Status:      200,
		},
		{
		...
		},
		{
			...
			Body:        ``,
			Expected:    `{"name":"table2","schema":"public","owner":"admin","comment":null,"rowsecurity":false,"hasindexes":false,"hastriggers":false,"ispartition":false,"constraints":null,"columns":[{"name":"a\"a","type":"int4","notnull":false,"default":null,"readonly":false,"comment":null,"constraints":null,"table":"table2","schema":"public"}]}`,
			Status:      200,
		},
		{
			Description: "insert in the table",
